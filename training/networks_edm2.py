...
class Precond(torch.nn.Module):
    def __init__(self,
        ...
        freeze_norm_layers=False, # Freeze normalization layers?
        freeze_conv_layers=False, # Freeze convolutional layers?
        ...
        **unet_kwargs,          # Keyword arguments for UNet.
        ...
        self._freeze_layers()
        # NOTE(gsunshine): The adaptive weighting proposed in EDM2 doesn't work well with multiple stage tuning.
