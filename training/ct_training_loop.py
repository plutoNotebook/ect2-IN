        ...
        for round_idx in range(num_accumulation_rounds):
            with misc.ddp_sync(ddp, (round_idx == num_accumulation_rounds - 1)):
                ...
                if stf:
                    ...
                    loss = loss_fn(net=ddp, images=batch_images, labels=batch_labels, stf=stf, ref_images=images)
                else:                      
                    batch_images = images
                    batch_labels = labels
                    loss = loss_fn(net=ddp, images=batch_images, labels=batch_labels)
